---
title: "Mapa de infraestructura verde del Corredor Biológico Interurbano Río Torres"
output: 
...
### Datos para descarga: [Capa geoespacial de infraestructura verde del Corredor Biológico Interurbano Río Torres](https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/infraestructura-verde/cbirt/IV_CBI_RIO_TORRES.TIF)
```{r}
